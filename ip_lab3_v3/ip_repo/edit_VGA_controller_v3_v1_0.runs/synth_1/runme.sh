...
HD_PWD='c:/users/albert.poblador/ip_lab3_v3/ip_repo/edit_VGA_controller_v3_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_controller_v3_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_controller_v3_v1_0.tcl
