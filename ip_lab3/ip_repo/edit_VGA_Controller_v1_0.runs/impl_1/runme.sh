...
HD_PWD='C:/Users/albert.poblador/ip_lab3/ip_repo/edit_VGA_Controller_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_Controller_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_Controller_v1_0.tcl -notrace
