...
-- Date        : Thu Nov 11 10:09:12 2021
-- Host        : c5b5 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/albert.poblador/lab3/lab3.gen/sources_1/bd/lab3/ip/lab3_VGA_Controller_0_0/lab3_VGA_Controller_0_0_sim_netlist.vhdl
-- Design      : lab3_VGA_Controller_0_0
...
entity lab3_VGA_Controller_0_0_VGA_Controller is
  port (
    vsync : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of lab3_VGA_Controller_0_0_VGA_Controller : entity is "VGA_Controller";
end lab3_VGA_Controller_0_0_VGA_Controller;

architecture STRUCTURE of lab3_VGA_Controller_0_0_VGA_Controller is
  ...
  signal \line_count[10]_i_2_n_0\ : STD_LOGIC;
  signal \line_count[10]_i_4_n_0\ : STD_LOGIC;
  signal \line_count[10]_i_5_n_0\ : STD_LOGIC;
  signal \line_count[10]_i_6_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of hsync_i_4 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \line_count[10]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \line_count[10]_i_5\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \line_count[10]_i_6\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \line_count[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \line_count[3]_i_1\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \pixel_count[3]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \pixel_count[4]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \pixel_count[7]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \pixel_count[8]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \pixel_count[9]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \red[1]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \red[2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \red[3]_i_10\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \red[3]_i_5\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \red[3]_i_8\ : label is "soft_lutpair3";
...
\green[3]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"04000F00"
    )
        port map (
...
\line_count[10]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"80FF"
    )
        port map (
      ...
      I1 => \red[3]_i_3_n_0\,
      I2 => \line_count[10]_i_2_n_0\,
      I3 => s00_axi_aresetn,
      O => \line_count[10]_i_1_n_0\
    );
\line_count[10]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80808000"
    )
        port map (
      I0 => \line_count[10]_i_4_n_0\,
      I1 => pixel_count_reg(9),
      I2 => pixel_count_reg(10),
      I3 => pixel_count_reg(7),
      I4 => pixel_count_reg(8),
      O => \line_count[10]_i_2_n_0\
    );
\line_count[10]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => line_count_reg(8),
      I2 => line_count_reg(7),
      I3 => \line_count[10]_i_5_n_0\,
      I4 => \line_count[10]_i_6_n_0\,
      I5 => line_count_reg(9),
      O => \plusOp__0\(10)
    );
\line_count[10]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFEFEFE"
    )
        port map (
...
\line_count[10]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
      ...
      I3 => line_count_reg(2),
      I4 => line_count_reg(4),
      O => \line_count[10]_i_5_n_0\
    );
\line_count[10]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\pixel_count[10]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
      I0 => \line_count[10]_i_2_n_0\,
      I1 => s00_axi_aresetn,
      O => \pixel_count[10]_i_1_n_0\
    );
\pixel_count[10]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"A6AA"
    )
        port map (
...
\pixel_count[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => pixel_count_reg(5),
      I2 => pixel_count_reg(6),
      I3 => \pixel_count[7]_i_2_n_0\,
      I4 => pixel_count_reg(4),
      I5 => pixel_count_reg(3),
      O => \pixel_count[7]_i_1_n_0\
    );
\pixel_count[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\red[3]_i_8\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity lab3_VGA_Controller_0_0_VGA_Controller_v1_0_S00_AXI is
  port (
    vsync : out STD_LOGIC;
    hsync : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of lab3_VGA_Controller_0_0_VGA_Controller_v1_0_S00_AXI : entity is "VGA_Controller_v1_0_S00_AXI";
end lab3_VGA_Controller_0_0_VGA_Controller_v1_0_S00_AXI;

architecture STRUCTURE of lab3_VGA_Controller_0_0_VGA_Controller_v1_0_S00_AXI is
  signal \^s_axi_arready\ : STD_LOGIC;
  signal \^s_axi_awready\ : STD_LOGIC;
  signal \^s_axi_wready\ : STD_LOGIC;
  signal VGA_Controller_instance_n_1 : STD_LOGIC;
...
VGA_Controller_instance: entity work.lab3_VGA_Controller_0_0_VGA_Controller
     port map (
      Q(0) => slv_reg0(0),
      SR(0) => VGA_Controller_instance_n_1,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity lab3_VGA_Controller_0_0_VGA_Controller_v1_0 is
  port (
    vsync : out STD_LOGIC;
    hsync : out STD_LOGIC;
    S_AXI_AWREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of lab3_VGA_Controller_0_0_VGA_Controller_v1_0 : entity is "VGA_Controller_v1_0";
end lab3_VGA_Controller_0_0_VGA_Controller_v1_0;

architecture STRUCTURE of lab3_VGA_Controller_0_0_VGA_Controller_v1_0 is
begin
VGA_Controller_v1_0_S00_AXI_inst: entity work.lab3_VGA_Controller_0_0_VGA_Controller_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity lab3_VGA_Controller_0_0 is
  port (
    hsync : out STD_LOGIC;
    vsync : out STD_LOGIC;
    red : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute NotValidForBitStream of lab3_VGA_Controller_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of lab3_VGA_Controller_0_0 : entity is "lab3_VGA_Controller_0_0,VGA_Controller_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of lab3_VGA_Controller_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of lab3_VGA_Controller_0_0 : entity is "VGA_Controller_v1_0,Vivado 2020.2";
end lab3_VGA_Controller_0_0;

architecture STRUCTURE of lab3_VGA_Controller_0_0 is
...
U0: entity work.lab3_VGA_Controller_0_0_VGA_Controller_v1_0
     port map (
