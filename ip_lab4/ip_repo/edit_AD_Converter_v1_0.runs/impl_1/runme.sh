...
HD_PWD='C:/Users/albert.poblador/ip_lab4/ip_repo/edit_AD_Converter_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AD_Converter_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AD_Converter_v1_0.tcl -notrace
