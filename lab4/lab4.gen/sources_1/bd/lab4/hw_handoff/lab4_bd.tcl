...
proc create_root_design { parentCell } {
  ...
  # Create instance: AD_Converter_0, and set properties
  set AD_Converter_0 [ create_bd_cell -type ip -vlnv ALU:user:AD_Converter:1.0 AD_Converter_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins AD_Converter_0/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]

  # Create port connections
  connect_bd_net -net AD_Converter_0_leds [get_bd_ports leds] [get_bd_pins AD_Converter_0/leds]
  connect_bd_net -net AD_Converter_0_ncs [get_bd_ports ncs] [get_bd_pins AD_Converter_0/ncs]
  connect_bd_net -net AD_Converter_0_sclk [get_bd_ports sclk] [get_bd_pins AD_Converter_0/sclk]
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins gen_fun_top_0/clk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins AD_Converter_0/s00_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AD_Converter_0/s00_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins gen_fun_top_0/reset]
  connect_bd_net -net sdata1_1 [get_bd_ports sdata1] [get_bd_pins AD_Converter_0/sdata1]
  connect_bd_net -net sdata2_1 [get_bd_ports sdata2] [get_bd_pins AD_Converter_0/sdata2]
  connect_bd_net -net select_in_1 [get_bd_ports select_in] [get_bd_pins gen_fun_top_0/select_in]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AD_Converter_0/S00_AXI/S00_AXI_reg] -force
